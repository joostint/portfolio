...
const words = ["a UX Designer.", "a cat dad.", "a Buckeye.", "a pickle hater.", "a Cavs fan.", "goofy-footed.", "from Cleveland.", "double-jointed.", "introverted.", "a keyboard wizard.", "Vietnamese", "constantly iterating.", "an amateur fisher."];
